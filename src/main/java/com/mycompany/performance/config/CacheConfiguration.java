package com.mycompany.performance.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.mycompany.performance.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.mycompany.performance.repository.UserRepository.USERS_BY_EMAIL_CACHE);
