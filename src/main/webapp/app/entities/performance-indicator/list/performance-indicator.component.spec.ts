...
describe('PerformanceIndicator Management Component', () => {
  let comp: PerformanceIndicatorComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'performance-indicator', component: PerformanceIndicatorComponent }]),
      ...
      .overrideTemplate(PerformanceIndicatorComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.performanceIndicators?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to performanceIndicatorService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPerformanceIndicatorIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPerformanceIndicatorIdentifier).toHaveBeenCalledWith(entity);
